...
def _swap_wordmark_rels(data):
    """Point the footer wordmark relationships at our padded PNG instead of the
    template's EMF, whose glyph bottoms clip in several renderers."""
    return data.replace(b"../media/image1.emf", b"../media/inl_wordmark.png")
        ...
        with zipfile.ZipFile(INL_POTX) as zin, \
            ...
            for item in zin.infolist():
                ...
                if item.filename.endswith(".rels"):
                    data = _swap_wordmark_rels(data)
                zout.writestr(item, data)
            zout.writestr("ppt/media/inl_wordmark.png",
                          (HERE / "inl_wordmark.png").read_bytes())
