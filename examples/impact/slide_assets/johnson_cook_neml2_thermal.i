...
#
# !!! ONE THING TO VALIDATE AT RUNTIME: old_state/T must be initialized to 300 K.
#     A NEML2 state defaults to 0 -> T*=(0-300)/1038 < 0 on step 1. See the
#     scoping doc (THERMOMECHANICAL_SCOPING.md) for the two ways to seed T0=300.
...
[Models]
  ...
  [integrate_T]
    ...
    variable = 'state/T' # auto-uses state/T_rate and old_state/T
  []
  # ==========================================================================
  ...
  [model]
    ...
    additional_outputs = 'state/s state/ep state/S state/Ep state/T'
  []
[]
